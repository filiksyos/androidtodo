...
MODULE_DIRS = ["app", "data", "domain", "presentation", "resources"]  # Include all modules
EXCLUDE_DIRS = ["app/build", "data/build", "domain/build", "presentation/build", "resources/build"]  # Exclude build directories
